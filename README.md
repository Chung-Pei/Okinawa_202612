...
The Pages workflow is configured in [`.github/workflows/pages.yml`](.github/workflows/pages.yml). Daily maps use public Google My Maps iframe URLs configured in `site/config.js`; no Google Maps API key is stored in this repository.
